...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "createRule": "verified = false",
      "deleteRule": "verified = false",
      "emailChangeToken": {
        "duration": 1800
      },
      "fields": [
    ...
    },
    {
      ...
      "viewRule": "@request.auth.id = employer.id || employees.id ?= @request.auth.id"
    },
    {
      "createRule": "@request.auth.id = createdBy",
      "deleteRule": "@request.auth.id = workplace.employer",
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
          "hidden": false,
      ...
      "type": "base",
      "updateRule": null,
      "viewRule": "@request.auth.id = workplace.employer"
    },
    {
      "createRule": null,
      "deleteRule": null,
      ...
      "type": "view",
      "updateRule": null,
      "viewQuery": "SELECT users.id, SUM(JSON_ARRAY_LENGTH(workplace.employees)) as value\nFROM users\nJOIN workplace ON users.id = workplace.employer\nGROUP BY users.id;",
